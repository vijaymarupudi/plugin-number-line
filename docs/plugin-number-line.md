...
When using images, they are displayed in the same pixel resolution of the corresponding files and must be hosted on a server.
...
var trial = {
    type: jsPsychPluginNumberLine,
    image_min: "img_min_demo.png",
    image_max: "img_max_demo.png",
    stimage: "img_stimulus_demo.png",
    line_type: "universal",
    start_tick_coords: [50, 150],
    canvas_width: 600,
    canvas_height: 300,
